...
const _countries = [
  _C('🇱🇰','Sri Lanka','94'), _C('🇮🇳','India','91'),
  _C('🇵🇰','Pakistan','92'), _C('🇧🇩','Bangladesh','880'),
  _C('🇬🇧','UK','44'), _C('🇺🇸','USA','1'),
  _C('🇦🇺','Australia','61'), _C('🇩🇪','Germany','49'),
  _C('🇸🇦','Saudi Arabia','966'), _C('🇦🇪','UAE','971'),
  _C('🇲🇾','Malaysia','60'), _C('🇸🇬','Singapore','65'),
  _C('🇯🇵','Japan','81'), _C('🇰🇷','S.Korea','82'),
  _C('🇧🇷','Brazil','55'), _C('🇿🇦','S.Africa','27'),
];
