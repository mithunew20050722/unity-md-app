...
class _ParticlePainter extends CustomPainter {
  ...
  void paint(Canvas c, Size s) {
    for (final pt in p) {
      c.drawCircle(Offset(pt.x * s.width, pt.y * s.height), pt.r,
        Paint()..color = const Color(0xFF25D366).withOpacity(pt.opacity));
    }
  }
  @override bool shouldRepaint(_ParticlePainter _) => true;
}
...
class _HomeScreenState extends State<HomeScreen>
  ...
  @override
  void dispose() {
    _pollTimer?.cancel(); _particleTimer?.cancel(); _glowCtrl.dispose();
    super.dispose();
  }
      ...
      builder: (_, __) {
        ...
        return Scaffold(
          ...
          body: Stack(children: [
            ...
            // Glows
            AnimatedBuilder(animation: _glowCtrl, builder: (_, __) => Stack(children: [
              Positioned(top: -80 + _glowCtrl.value * 20, left: -80,
                child: _glow(const Color(0xFF25D366), 240 + _glowCtrl.value * 20)),
              Positioned(bottom: -80, right: -80,
                child: _glow(const Color(0xFF00E5FF), 180 + _glowCtrl.value * 20)),
              Positioned(
                top: MediaQuery.of(context).size.height * 0.4,
                left: MediaQuery.of(context).size.width * 0.3,
                child: _glow(const Color(0xFFA259FF), 100 + _glowCtrl.value * 10)),
            ])),
            // Content
            RefreshIndicator(
              onRefresh: _load,
  ...
  PreferredSizeWidget _appBar(l) => AppBar(
    backgroundColor: const Color(0xFF030610).withOpacity(0.9),
    elevation: 0,
    ...
    actions: [
      ...
      PopupMenuButton<String>(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: BorderSide(color: const Color(0xFF25D366).withOpacity(0.1))),
        onSelected: (v) {
    ...
    builder: (_, __) => Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [_col.withOpacity(0.09 + _glowCtrl.value * 0.03),
            const Color(0xFF060A14)]),
        borderRadius: BorderRadius.circular(24),
        border: Border.all(color: _col.withOpacity(0.22)),
        boxShadow: [BoxShadow(
          color: _col.withOpacity(0.08 + _glowCtrl.value * 0.04),
      ...
      child: Column(children: [
        Stack(alignment: Alignment.center, children: [
          Container(width: 48, height: 48,
            decoration: BoxDecoration(shape: BoxShape.circle,
              color: _col.withOpacity(0.06 + _glowCtrl.value * 0.06))),
          Container(width: 14, height: 14,
            decoration: BoxDecoration(color: _col, shape: BoxShape.circle,
              boxShadow: [BoxShadow(
                color: _col.withOpacity(0.7), blurRadius: 12, spreadRadius: 2)])),
        ]),
        const SizedBox(height: 16),
        Text(l.statusLabel(_status),
          style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: _col)),
    ...
    l.featureCards.asMap().entries.map((e) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: c.withOpacity(0.04), blurRadius: 16)]),
        child: ListTile(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          begin: Alignment.topLeft, end: Alignment.bottomRight),
        borderRadius: BorderRadius.circular(18),
        border: Border.all(color: const Color(0xFFA259FF).withOpacity(0.25)),
        boxShadow: [BoxShadow(
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        ShaderMask(
          shaderCallback: (r) => const LinearGradient(
            colors: [Color(0xFFA259FF), Color(0xFF00E5FF)]).createShader(r),
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(colors: [
                c.color.withOpacity(0.07), const Color(0xFF060A14)],
        ...
        SizedBox(
          ...
          child: ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              foregroundColor: Colors.white54, elevation: 0,
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(14),
